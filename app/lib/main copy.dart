          ...
          child: ListView(
            children: <Widget>[
              ...
              TextButton(
                ...
                onPressed: _pdfDoc != null ? _postTextToEndpoint : null,
              ),
              Padding(
                child: Text(
                  _pdfDoc == null
    ...
    if (_text.isNotEmpty) {
      final response = await http.post(
        ...
        headers: <String, String>{
          ...
          'Bypass-Tunnel-Reminder': 'thuhuh', // Added the custom header
        },
        body: jsonEncode(<String, dynamic>{
          'input': {'content': _text}, // Modified the payload structure
        }),
      );
